...
var MatomoTracker = /** @class */ (function () {
    ...
    MatomoTracker.prototype.track = function (_a) {
        var _this = this;
        var _b = _a.data, data = _b === void 0 ? [] : _b, _c = _a.documentTitle, documentTitle = _c === void 0 ? window.document.title : _c, _d = _a.href, href = _d === void 0 ? window.location.href : _d, _e = _a.customDimensions, customDimensions = _e === void 0 ? false : _e;
        if (data.length) {
            if (customDimensions &&
